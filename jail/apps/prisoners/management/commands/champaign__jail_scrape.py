...
BASE_URL = "http://www.co.champaign.il.us/shoff/Inmpubsel.htm"
SEARCH_URL = 'http://sheriff.co.champaign.il.us/sdwebapp/inmpubsel.pgm'
...
class Command(BaseCommand):    
    ...
    def extract_inmate_urls(self, inmate_search_page):
            ...
            return document('#wrapper table tr td:last-child a')
    ...
    def handle(self, *args, **options):
        ...
        for search_term in search_list:
            ...
            post_values = {'LName': search_term, 'FName': '', 'MName': '', 'Suffix': ''}
